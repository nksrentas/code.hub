    ...
    <>
      <Table responsive>
        <tbody>
          <tr>
            <td>
              <FontAwesomeIcon icon={faInfoCircle} color='#2471A3' /> Course
              Number
            </td>
          ...
          <tr>
            <td>
              <FontAwesomeIcon icon={faCalendarAlt} color='#2471A3' /> Classes
              Start
            </td>
          ...
          <tr>
            <td>
              <FontAwesomeIcon icon={faTag} color='#2471A3' /> Cost of
              attendance
            </td>
          ...
          <tr>
            <td>
              <FontAwesomeIcon icon={faFileSignature} color='#2471A3' />{' '}
              Bookable:
            </td>
            <th style={{ textAlign: 'right' }}>
              {course.open ? (
